...
public class Program {
    ...
    public static void printTransaction(Transaction transaction) {
        System.out.println("id: " + transaction.getIdentifier() + ", Recipient: " + transaction.getRecipient().getName() + ", Sender: " + transaction.getSender().getName() + ", Transfer category " + transaction.getTransferCategory() + ", Transfer amount " + transaction.getTransferAmount());
    }
