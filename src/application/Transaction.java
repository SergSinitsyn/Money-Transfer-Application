...
public class Transaction {
    ...
    public Transaction(UUID identifier,
        ...
        //     return;
        // }
        // if (!checkTransferAmount(recipient, sender,
    ...
    private boolean checkTransferCategory(TransferСategory transferCategory,
                                          double transferAmount) {
        return (((transferCategory == TransferСategory.CREDIT)
                && (transferAmount < 0))
                || ((transferCategory == TransferСategory.DEBIT)
                && (transferAmount > 0)));
    }

    private boolean checkTransferAmount(User recipient,
                                        User sender,
                                        TransferСategory transferCategory,
                                        double transferAmount) {
        if ((transferCategory == TransferСategory.CREDIT)
        ...
        if ((transferCategory == TransferСategory.DEBIT)
