...
Functioning money transfer application with a console menu.
...
## Description
- The code follows [Oracle standards](https://www.oracle.com/java/technologies/javase/codeconventions-namingconventions.html).
...
3. Compile `javac application/Program.java`
4. Run in production mode `java application/Program --profile=production`
5. Run in development mode `java application/Program --profile=dev`

### Usage

Each menu item accompanied by the number of the command entered by a user to call an action.
